...
export function describeResponseMode(mode: ResponseMode): string {
  return {
    casual: "живой обычный разговор; можно говорить о нерабочем, настроении, играх, музыке, еде и мелочах; естественность важнее пользы, структуры и next step; завершай точкой или выводом, не вопросом",
    direct_answer:
    ...
    emotional_support: "спокойная поддержка без приторности, диагнозов и навязчивого утешения; завершай утверждением, вопрос только если без ответа нельзя продолжить",
