...
export function buildCapabilitiesOverview(
  ...
  const sections: string[] = [
    ...
    `• Level: ${settings.initiativeLevel}, smalltalk ~${settings.proactiveSmalltalkIntervalMinutes} min, advice ~${settings.proactiveAdviceIntervalMinutes} min, no daily cap`,
